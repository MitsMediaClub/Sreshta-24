...
export default function Faq() {
  ...
  const faqs = [
    ...
    {
      question: "DO WE HAVE A THEME FOR SHRESHTA’24?",
      answer:
        "The theme we have chosen after much thought and deliberation for shreshta’24 is COMICS cause who doesn’t want a platform that aims at providing networking and collaboration among artists, storytellers, technologists, and enthusiasts, fostering a vibrant and creative community and most importantly let us relive our childhoods.",
    },
    {
      question: "HIGHLIGHTS OF SHRESHTA’24",
      answer:
        "At shreshta’24 get ready to experience the adventure of a lifetime. Buckle up and get ready to experience once in a lifetime encounters such as band wars, eneria and a mind blowing theme show",
    },
    {
      question: "HOW CAN I REGISTER FOR SHRESHTA’24?",
      answer:
        "Please fill out the registration form on the Shreshta’24 website.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Please visit the Shreshta’24 website for more information on how to get to the event.",
    },
  ];
