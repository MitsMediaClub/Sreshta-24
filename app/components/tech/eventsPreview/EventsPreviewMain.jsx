        ...
        {events.map((event, index) => (
          ...
          >
            ...
            <div
              ...
              alt="Event"
              className="brightness-50 z-0 w-56 h-[20rem] md:w-96 md:h-[40rem] object-cover shrink-0 bg-cover bg-center"
            />
          </div>
        ))}
        <Image
          ...
          className="w-56 h-[20rem] md:w-96 md:h-[40rem] mr-4 lg:hover:scale-105 transition-all ease-in-out duration-300 cursor-pointer"
        />
      </div>
    </div>
  );
