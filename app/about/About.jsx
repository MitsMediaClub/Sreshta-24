...
export default function AboutPage() {
    ...
    return (
      ...
      <div className={`md:block hidden absolute h-4 pt-4 top-0 left-0 right-0 z-40 w-full  `}>
          <div className="flex flex-row justify-between  2xl:mx-16 xl:mx-[3.5rem]  lg:mx-[3rem] mx-6 ">
            <div
              className={`${show?' 2xl:w-auto bg-clip-padding  border-tech-bg  xl:w-[8rem] lg:w-[6rem] delay-700':''}  w-[5rem] flex justify-center items-center `}
            >
            ...
            <div
              className={` cursor-pointer ${show?' 2xl:w-auto bg-clip-padding  border-tech-bg':''}   xl:w-[8rem] lg:w-[6rem]  w-[5rem]`}
            >
              <Image
                onClick={hamburger}
              ...
              <div>
                ...
                <div>
                <p className='w-full text-white h-1/2 bangers font-normal md:text-xxxl text-9xl items-center drop-shadow-title text-center self-center p-24'>OUR TEAM</p>
                <p className='w-full h-1/4 gooddog text-black self-center text-3xl text-center'>The Heroes, the Legends, the Myths</p>
                <Image
            ...
            <div className=''>
                <div className='pt-12'>
                    <div className='w-full h-1/5 bangers text-6xl self-center text-center text-[#285F5F]'>STUDENT COUNCIL</div>
                    <Cards data={studentCouncil} />
                </div>
                <div className='pt-12'>
                    <div className='w-full h-1/5 bangers text-6xl self-center text-center text-[#285F5F]'>MEDIA CLUB</div>
                    <Cards data={mediaClub} />
                </div>
                <div className='pt-12'>
                    <div className='w-full h-1/5 bangers text-6xl self-center text-center text-[#285F5F]'>WEB TEAM</div>
                    <Cards data={webTeam} />
